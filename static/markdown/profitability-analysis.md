...
ROIC draws on income-statement and balance-sheet items. As a non-standard measure, it requires judgment. (This article presents a common method, but not the only one.) The calculation is complicated because financial statements reflect both operating and financing decisions. To isolate operating decisions, the calculation excludes or adjusts numbers affected by financing.
